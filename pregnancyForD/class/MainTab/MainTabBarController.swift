...
class MainTabBarController: UITabBarController {
    ...
    override func viewDidLoad() {
        ...
        addChildViewController(childControllerName: "FirstPageViewController", title: "首页", normalImage: "HC-shouY")
        addChildViewController(childControllerName: "HomeTableViewController", title: "咨询消息", normalImage: "HC-xiaoxi")
        addChildViewController(childControllerName: "GroupViewController", title: "患者管理", normalImage: "HC-huanzhe")
        addChildViewController(childControllerName: "UserTableViewController", title: "个人", normalImage: "HC-geren")
